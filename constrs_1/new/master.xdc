...
# Clock signal
set_property PACKAGE_PIN W5 [get_ports masterclk]							
	set_property IOSTANDARD LVCMOS33 [get_ports masterclk]
...
#set_property PACKAGE_PIN K17 [get_ports {speakerC}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {speakerC}]
##Sch name = JC2
set_property PACKAGE_PIN H1 [get_ports {speakerC}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {speakerC}]
##Sch name = JC2
set_property PACKAGE_PIN A15 [get_ports {speakerD}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {speakerD}]
##Sch name = JC3
set_property PACKAGE_PIN L17 [get_ports {speakerE}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {speakerE}]
	
##Sch name = JC4
set_property PACKAGE_PIN K3 [get_ports {speakerF}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {speakerF}]
##Sch name = JC7
set_property PACKAGE_PIN M2 [get_ports {speakerG}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {speakerG}]
##Sch name = JC3
#set_property PACKAGE_PIN J1 [get_ports {speakerE}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {speakerE}]
	
##Sch name = JC4
#set_property PACKAGE_PIN J3 [get_ports {speakerD}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {speakerD}]
...
set_property PACKAGE_PIN T17 [get_ports F]                        
